...
from jupyturtle.jupyturtle import Drawing
...
class DrawingContext:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        if self.output_path:
            self.turtle.hide()
            self.turtle.drawing.width = self.page.furthest_from_left_px + self.page.vowel_area_height_px
            self.turtle.drawing.height = self.page.furthest_from_top_px + self.page.vowel_area_height_px
